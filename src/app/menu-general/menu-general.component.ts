...
export class MenuGeneralComponent implements OnInit {
  ...
  _menuList: any = [
                    ...
                    {categoria: "S", icono: "fa-solid fa-circle-exclamation", idMenu: "docBitSeg", Nombre: "Registro de Bitácora Seguridad", Descripcion: "Permite ingresar la ubicación, comentarios, litros, horometro, odometro de Equipos y Maquinaria."},
                    {categoria: "A", icono: "fa-solid fa-circle-exclamation", idMenu: "docBitSeg", Nombre: "Registro de Bitácora Seguridad", Descripcion: "Permite ingresar la ubicación, comentarios, litros, horometro, odometro de Equipos y Maquinaria."},
